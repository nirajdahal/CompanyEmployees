    ...
    public partial class AddRole : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3871c307-2f79-42c4-9b2c-a6bd160c7397", "a8544d93-108e-421a-87f9-c2595c24b7bd", "Manager", "MANAGER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "5832e925-598b-4023-883d-85b6324014ea", "8173448f-eb12-456f-8126-86f0685b2232", "Administrator", "ADMINISTRATOR" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "3871c307-2f79-42c4-9b2c-a6bd160c7397");

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "5832e925-598b-4023-883d-85b6324014ea");
